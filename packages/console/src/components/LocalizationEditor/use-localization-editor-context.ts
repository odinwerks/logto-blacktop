...
export const LocalizationEditorContext = createContext<Context>({
  selectedLanguage: 'en',
...
const useLocalizationEditorContext = () => {
  ...
  return {
    context,
    Provider: LocalizationEditorContext.Provider,
  };
};

export default useLocalizationEditorContext;
